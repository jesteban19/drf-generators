...
``--serializer-file``      output file for serializers
``--view-file``            output file for views
``--url-file``             output file for urls
========================== ===================================================
...
.. code-block:: bash
    ...
    $ python manage.py generate api --format function --force --models "ModelName" --url-file "my_url_custom.py"
